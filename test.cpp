...
int main(int argc, char* argv[])
{
    ...
    switch(my_rank)
    {
        case SENDER:
        {
            ...
            buffer.age = 20;
            buffer.height = 1.83;
            buffer.name = "Tom 1 Hello";
            printf("MPI process %d sends person:\n\t- age = %d\n\t- height = %f\n\t- name = %s\n", my_rank, buffer.age, buffer.height, buffer.name.c_str());
        ...
        case RECEIVER:
        {
            ...
            printf("MPI process %d received person:\n\t- age = %d\n\t- height = %f\n\t- name = %s\n", my_rank, received.age, received.height, received.name.c_str());
            break;
        }
    }
